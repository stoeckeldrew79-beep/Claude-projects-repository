  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="mt-3 max-w-2xl text-slate-600">
        Real report counts by country, from the curated public database — drag to rotate. This shows where
        activity has actually been recorded, not a prediction of where scams will happen next.
      </p>

      <div className="mt-8 rounded-xl border border-slate-200 bg-[#0f1a2b] p-6">
