...
UsNS.push({
    name: 'San Jose "VIP Eventss" Quinceañera Planner Fraud',
    slug: 'san-jose-vip-eventss-quinceanera-planner-fraud',
    description: `Juan Martin Gaspar, 51 — who also goes by Juan Martin Barcenas — ran a San Jose, California event-planning business styled "VIP Eventss" (also advertised as "VIP Eventos") that took large upfront fees from Spanish-speaking families to organize their daughters' quinceañeras, then allegedly never paid the venues, caterers, and other vendors those fees were supposed to cover. One mother paid Gaspar $4,250 in August 2024 to plan her daughter's 15th-birthday celebration in Milpitas; another couple paid him $13,000 for a quinceañera at a hall on Camden Avenue. According to the Santa Clara County District Attorney's Office, at least seven families hired Gaspar between 2023 and 2024, and in multiple cases families arrived at the venue on the day of the celebration to discover nothing had actually been booked or paid for — in some instances confronted on the spot by unpaid vendors demanding payment before they would proceed. The DA's Bureau of Investigations opened its case after local news coverage prompted a victim to file a complaint with the office's Consumer Protection Unit. Gaspar was arraigned on September 25, 2025 on seven counts of felony grand theft, was released on $100,000 bail, was ordered not to work as an event planner while the case is pending, and faces up to seven years in prison if convicted; his next court date was set for December 2, 2025. "The memories of that special day should be wonderful ones, not the memory of being ripped off by someone you trusted," District Attorney Jeff Rosen said in announcing the charges. Families booking a quinceañera, wedding, or other milestone event through an independent planner are advised to pay deposits directly to the venue and vendors whenever possible rather than funneling the full amount through a planner, to get a written contract itemizing exactly what has been paid and to whom, and to confirm directly with the venue that a reservation and payment have actually been received well before the event date.`,
    categorySlug: 'online-shopping-scams',
    alertLevel: 'high',
    sources: ["Santa Clara County District Attorney's Office", 'CBS News San Francisco', 'ABC7 News'],
    sourceUrl: 'https://www.cbsnews.com/sanfrancisco/news/san-jose-quinceanera-planner-vip-eventss-grand-theft-charges/',
    country: 'US',
    state: 'CA',
});
...
UsNS.push({
    name: 'Operation Nightingale Fake Nursing Diploma Scheme (Phase II)',
    slug: 'operation-nightingale-fake-nursing-diploma-scheme-phase-two',
    description: `Federal investigators codenamed "Operation Nightingale" uncovered a scheme in which owners, officers, and recruiters at a network of for-profit, state-approved South Florida nursing schools — including Palm Beach School of Nursing, Siena College, and Sacred Heart International Institute — sold fake diplomas and transcripts from 2016 to 2021 to people who wanted to become licensed registered or practical nurses without completing real coursework or clinical training. Buyers paid roughly $10,000 for a fraudulent LPN credential and $17,000 for an RN credential, and prosecutors say the scheme generated approximately $114 million while flooding hospitals and clinics nationwide with more than 7,300 unqualified people carrying real nursing licenses obtained on fake paper. Phase I of the investigation convicted 30 defendants in 2023. On September 15, 2025, the U.S. Attorney's Office for the Southern District of Florida announced Phase II, charging 12 more defendants — including Techni-Pro Institute owner Gilbert Hyppolite, 73, of Boca Raton; Agape Academy of Sciences manager Irene Matthews, 55, of Delray Beach; Azure College admissions director Jose Napoleon, 40; Sigma Institute of Health Careers owner Patrick Buchanan, 40; Carleen Home Health School president Carleen Noreus, 51; and Herline Lochard, 46, who managed the Center for Professional Training and Development and Orlando's Wheatland Institute — each with conspiracy to commit wire fraud, carrying up to 20 years in prison. Lochard pleaded guilty and was sentenced on July 31, 2026 to 13 months in prison followed by three years of supervised release; Palm Beach School of Nursing owner Johanah Napoleon was separately sentenced to 21 months and ordered to forfeit $3.2 million. More than 40 people have now been charged across both phases. Patients and employers have no way to detect a diploma-mill credential from the license alone, since the fraudulent nurses passed the same state licensing exam as legitimate graduates; hospitals and home-health agencies are advised to verify a nursing school's accreditation status directly with the relevant state board of nursing rather than relying on a candidate's diploma or transcript alone, and prospective nursing students should confirm a program's accreditation before enrolling or paying any tuition.`,
    categorySlug: 'student-loan-education',
    alertLevel: 'critical',
    sources: ['U.S. Department of Justice (Southern District of Florida)', 'Federal Bureau of Investigation'],
    sourceUrl: 'https://www.justice.gov/usao-sdfl/pr/fraud-charges-filed-against-12-defendants-phase-ii-operation-nightingale',
    country: 'US',
    state: 'FL',
});
...
UsNS.push({
    name: 'Bankowski Family Counterfeit Art Consignment Scheme',
    slug: 'new-jersey-bankowski-counterfeit-art-scheme',
    description: `From 2020 through 2025, Erwin Bankowski, 50, and his daughter Karolina Bankowska, 26, of Lawrence, New Jersey, consigned more than 200 counterfeit artworks to galleries and auction houses across the United States, falsely attributing the pieces to Andy Warhol, Pablo Picasso, Banksy, and Native American artist Fritz Scholder, according to federal prosecutors in the Eastern District of New York. The counterfeits themselves were produced in Poland by an unnamed co-conspirator, and the father-daughter pair built an elaborate paper trail to make them look real: fabricated ownership histories tracing each piece back through invented prior collectors, and forged gallery stamps crafted with custom-made stamping tools pressed onto deliberately aged paper, paired with fake certificates of authenticity. The scheme moved counterfeit pieces through the legitimate art market at prices ranging from roughly $2,000 for a fake Banksy protest print up to $160,000 for a counterfeit landscape falsely attributed to artist Richard Mayhew, sold through the Detroit auction house DuMouchelles in October 2025, and defrauded buyers and consignors of at least $2 million in total. Because one forged work was passed off as authentic Native American-made art, the pair also faced a charge under the Indian Arts and Crafts Act; U.S. Department of the Interior Indian Arts and Crafts Board director Meridith Stanton said of the enforcement effort, "For those selling counterfeit Indian art it is important to know that wherever you are we will diligently work to find you." Bankowski and Bankowska pleaded guilty on April 28, 2026 before U.S. District Judge Nicholas G. Garaufis in Brooklyn to wire fraud conspiracy and misrepresentation of Native American-produced goods, each facing a maximum of 20 years in prison and restitution of at least $1.9 million, in a case announced by then-U.S. Attorney Joseph Nocella Jr. Buyers, galleries, and auction houses acquiring a high-value work by a well-known artist should independently verify its provenance and certificate of authenticity with the artist's estate, foundation, or catalogue raisonné rather than trusting paperwork supplied by the seller, and should treat a conveniently complete, unbroken ownership history for an otherwise underpriced "rediscovered" work as a reason for closer scrutiny, not reassurance.`,
    categorySlug: 'online-shopping-scams',
    alertLevel: 'high',
    sources: ["U.S. Attorney's Office for the Eastern District of New York", 'U.S. Department of the Interior (Indian Arts and Crafts Board)', 'ARTnews'],
...
UsNS.push({
    name: 'Eternity Pet Memorial Fake-Ashes Cremation Fraud (Patrick Vereb)',
    slug: 'pennsylvania-pittsburgh-vereb-pet-cremation-fraud',
    description: `Patrick Vereb, 70, owner of Vereb Funeral Home and its pet-cremation division, Eternity Pet Memorial, in Pittsburgh, Pennsylvania, took private-cremation fees directly from grieving pet owners and from nearly a dozen area veterinary practices between 2021 and 2024 — and, according to the Pennsylvania Attorney General's Office, did not actually cremate most of the animals privately as promised. Investigators say Vereb instead disposed of a large share of the pets' bodies at a landfill and handed grieving customers urns filled with ashes that were not their own animal's remains; small dogs under roughly 30 pounds, in particular, were rarely ever sent to a crematory at all, while the ashes of large dogs that were cremated were apparently divided up and distributed to represent multiple different pets. Nearly a dozen veterinary practices in Allegheny, Armstrong, Washington, and Westmoreland counties worked with the Attorney General's Office to confirm that Vereb had collected at least $657,517 in fees for cremation services never actually rendered as sold, with investigators estimating more than 6,500 pet owners were affected. Attorney General Dave Sunday announced felony charges against Vereb on April 28, 2025, covering theft by deception, receiving stolen property, and deceptive business practices, saying "This case is disturbing, and will cause devastation and heartache for many Pennsylvanians" because the pets involved were, for their families, "members of our families." The case was handled by Senior Deputy Attorney General Kara Rice and Deputy Attorney General Aaron McKendry, and the office set up a dedicated case-update and victim-contact page at attorneygeneral.gov/epm. Anyone paying for a pet's private cremation should ask the funeral home or crematory directly how individual identification is maintained throughout the process, request a certificate bearing a specific tracking or tag number tied to their pet rather than a generic receipt, and check a provider's licensing status and complaint history with the state Attorney General's consumer protection office before paying — since, as this case shows, there is often no way for a family to know their pet's ashes were never actually returned.`,
    categorySlug: 'online-shopping-scams',
    alertLevel: 'high',
    sources: ['Pennsylvania Office of Attorney General', 'CBS News Pittsburgh (KDKA)'],
    sourceUrl: 'https://www.attorneygeneral.gov/taking-action/ag-sunday-charges-pittsburgh-based-funeral-home-owner-with-deceiving-6500-pet-owners-who-paid-for-burial-services-but-received-ashes-from-other-animals/',
    country: 'US',
    state: 'PA',
});
...
UsNS.push({
    name: 'Matthew Veazey Fabricated-Message Friends-and-Family Investment Fraud',
    slug: 'oklahoma-city-veazey-friends-family-investment-fraud',
    description: `A federal grand jury in Oklahoma City indicted Matthew Mclain Veazey on a 30-count indictment on April 7, 2026, charging him with running a friends-and-family investment fraud scheme from June 2021 through December 2025 that took at least $2,385,000 from people who trusted him. According to the indictment, Veazey presented himself to friends and family members as an experienced, successful financial investment professional with special access to favorable opportunities through his industry connections and past employment at investment companies, and convinced them to send him money to invest on their behalf or alongside his own supposed investments. Investigators with IRS Criminal Investigation and the FBI's Oklahoma City Field Office say Veazey never actually invested the funds and instead spent victims' money on personal expenses, and that when questioned he fabricated text messages and emails, made to look like they came from real people, to convince victims his investment activity was legitimate and ongoing. The indictment charges 21 counts of wire fraud, 5 counts of money laundering, and 4 counts of aggravated identity theft, exposing Veazey to up to 20 years in prison and a $250,000 fine on each wire fraud count, up to 10 years and a $250,000 fine on each money laundering count, and a mandatory consecutive 2 years in prison on each aggravated identity theft count if convicted; as the U.S. Attorney's Office noted in announcing the charges, Veazey is presumed innocent unless and until proven guilty. Assistant U.S. Attorneys Jackson D. Eldridge and Julia E. Barry are prosecuting the case. Investment offers from a friend or family member deserve real scrutiny rather than less: ask to see account statements directly from the outside brokerage or custodian involved, verify that any referenced firm or license actually exists through FINRA's BrokerCheck or the SEC's EDGAR database, and treat a screenshot of a text or email as no substitute for a verifiable, independently issued account statement.`,
    categorySlug: 'investment-fraud',
    alertLevel: 'high',
    sources: ['IRS Criminal Investigation', "U.S. Attorney's Office, Western District of Oklahoma"],
    sourceUrl: 'https://www.irs.gov/compliance/criminal-investigation/oklahoma-city-man-charged-in-multi-million-dollar-investment-fraud-scheme',
    country: 'US',
    state: 'OK',
});
...
UsNS.push({
    name: 'Puerto Rico Luma Energy AI-Spoofed Shutoff Robocall Scam',
    slug: 'puerto-rico-luma-energy-ai-spoofed-shutoff-robocall-scam',
    description: `Puerto Rico's Department of Consumer Affairs (DACO) issued a public alert on July 10, 2026 after its Fraudulent Schemes Detection Unit identified a wave of robotic phone calls falsely claiming to be from Luma Energy, the island's private electric utility, demanding immediate payment on a supposed overdue balance and threatening to cut off service if the recipient didn't pay right away. The calls display spoofed 1-800 and 1-877 toll-free numbers designed to look like a legitimate utility line, but DACO Secretary Hiram Torres Montalvo said the numbers are "deepfakes, generados por algoritmos de inteligencia artificial generativa" (deepfakes generated by generative AI algorithms) used to disguise the calls' true origin, which investigators traced to the Asia Minor region rather than anywhere in Puerto Rico or the continental United States. Luma Energy's own management confirmed to DACO that the company does not call customers to demand payment and, critically, never threatens to disconnect service over the phone — any such call is fraudulent regardless of how official the displayed number looks. DACO's guidance is not to provide any personal information — full name, date of birth, Social Security number, or banking details — to an unsolicited caller under any circumstances, and to verify any claimed balance or shutoff notice only through Luma Energy's own official website or mobile app rather than trusting the caller's version of events. Residents who receive one of these calls can report it to the Puerto Rico Police Department or notify DACO through its "DACO a tu favor" social media accounts or www.daco.pr.gov.`,
    categorySlug: 'utility-scams',
    alertLevel: 'high',
