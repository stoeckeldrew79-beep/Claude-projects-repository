  ...
  },
{
  ...
  {
    name: "Storm-Chasing Tree Removal and Repair Contractor Scam",
    slug: "indiana-storm-chasing-tree-removal-contractor-scam",
    description: `Indiana Attorney General Todd Rokita issued a consumer alert on August 17, 2026, warning Hoosiers to watch for scam contractors descending on neighborhoods after a derecho packing winds up to 99 mph tore through the state on August 11, displacing more than 1,000 families and damaging over 1,700 structures across 54 counties, with widespread flooding compounding the damage. Fly-by-night operators went door-to-door in the hardest-hit areas, falsely telling homeowners that "FEMA will pay for all of this" to pressure them into signing a repair contract on the spot before they could get a second opinion or verify the company was legitimate. Rokita's office listed red flags separating a scam artist from a real contractor: high-pressure tactics demanding an immediate signature, verbal promises with nothing put in writing, an offer to waive or absorb the homeowner's insurance deductible (illegal in Indiana), and a large payment demanded upfront or in full before the work is finished. "These fraudsters prey on people at their most vulnerable," Rokita said. "Do your homework, be tenacious, demand everything in writing, and make sure your resources go to legitimate recovery — not into the pockets of con artists." On September 3, 2026, Rokita's office followed the alert with lawsuits against several of the contractors accused of exploiting storm victims, including Shade Tree Service Co., Storm Support Emergency Tree Removal, Timbercut Tree Experts, and Garrison McKinney Tree and Bridge Services. One suit describes an elderly Lake County woman who was quoted $40,000 by Garrison McKinney to remove two storm-damaged trees; when she said the cost would devastate her retirement savings, the contractor "discounted" it to $35,000 — still without a proper license, required written disclosures, or a contract containing basic consumer protections. "It is reprehensible, what these people are doing," Rokita said of the tactics, adding that "when you're at your lowest emotionally... that's when the bad guys will be bad guys." Homeowners are urged to get multiple written estimates, verify a contractor's registration and insurance before any money changes hands, and never pay the full cost upfront. Indiana residents who believe they've been targeted can contact the Attorney General's Consumer Protection Division at indianaconsumer.com or 1-800-382-5516.`,
    categorySlug: "home-improvement-solar",
    alertLevel: "high",
    sources: ["Indiana Attorney General's Office (Todd Rokita)", "Lakeshore Public Media", "Insurance Journal", "Hoodline"],
    sourceUrl: "https://www.lakeshorepublicmedia.org/local-news/2026-08-17/attorney-general-todd-rokita-warns-of-scammers-targeting-weary-hoosiers-following-damaging-storms-flooding",
    country: "US",
    state: "IN",
  },
  {
    name: "Fake 'Notice of Hearing' Traffic Violation Text Scam",
    slug: "kansas-fake-traffic-violation-notice-of-hearing-scam",
    description: `Kansas Attorney General Kris Kobach issued a consumer alert in late March 2026 warning residents about a growing scam built around fraudulent "Notice of Hearing" messages for alleged traffic violations, sent by text and email in a form designed to mimic a real court document. The fake notices are dressed up with realistic-looking court headings, case numbers, and statute citations, then paired with a QR code or link that urges the recipient to pay a fictitious fine and "associated costs" right away to avoid further penalties. Kobach's office stressed that real courts never send notices of a hearing or a traffic citation by text message or email, and warned that scanning the QR code or clicking the link can expose a device to malware in addition to harvesting payment information. A version of the scam that surfaced in Johnson County in early April 2026 impersonated the Johnson County District Court directly, falsely citing a hearing before "Judge Michael Rodriguez" — a name that does not correspond to any actual judge on that court — and, in one batch, was sent out on a holiday, when no court would be transmitting real notices. Consumers who receive one of these messages are advised not to reply, call any number in the message, scan the QR code, or click any link, and instead to contact the clerk of the relevant court directly using a phone number found independently on the court's official website. Kansans who receive a fraudulent notice are encouraged to report it to the Attorney General's Public Protection Division at www.ag.ks.gov or by calling (785) 296-3751 or 1-800-432-2310.`,
    categorySlug: "government-impersonation",
    alertLevel: "high",
    sources: ["Kansas Attorney General's Office (Kris Kobach)", "Fox4KC", "KOAM News Now", "KWCH"],
    sourceUrl: "https://www.ag.ks.gov/Home/Components/News/News/296/",
    country: "US",
    state: "KS",
  },
];
