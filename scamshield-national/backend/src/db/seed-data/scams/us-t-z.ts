...
UsTZ.push({
    name: "Texas's 1923 Blue Sky Law: How Worthless Oil Stock Created the State's First Investor Protections",
    slug: 'texas-1923-blue-sky-law-oil-stock-fraud-origin',
    description: `Texas passed a first, narrow securities-registration statute in 1913, following Kansas's pioneering 1911 "Blue Sky" law — a name regulators coined for stock promotions with no more real backing than "so many feet of blue sky." That early Texas law proved too weak to stop what came next: a wave of oil-company stock promotions swept through the state in 1918 and 1919, as speculators cashed in on the oil boom by selling shares in companies that owned no real wells, leases, or equipment, leaving investors holding certificates worth exactly what the "blue sky" name implied. The Thirty-eighth Texas Legislature responded on May 15, 1923, with House Bill 177, a comprehensive Blue Sky Law aimed squarely at the oil-stock racket: any company offering stock for sale in Texas now had to file an application with the secretary of state for a sales permit, disclosing the officers' business background and attaching an actual financial statement of the company's resources before a single share could legally be sold to the public. The law stayed in force until the Forty-fourth Legislature replaced it with the modern Securities Act in 1935, which created the Texas State Securities Board that still registers and polices securities offerings in the state today.

A century later, the exact vulnerability the 1923 law targeted — an "investment" sold to the public with no verifiable underlying business, no registration, and no real disclosure — is still the engine behind Texas investment fraud. On February 11, 2026, the Texas State Securities Board issued an emergency cease-and-desist order against TEXITcoin, its mining partner MineTXC, and founder Robert "Bobby" Gray, whose "Mining Packages" (marketed as "seats on the rocket ship") promised daily returns from cryptocurrency mining computing power but were, the Board alleged, unregistered securities sold by unregistered sellers who never disclosed the company's finances or how the mining operation and coin custody actually worked — the same missing financial statement and missing registration that House Bill 177 was written specifically to require in 1923, just with a crypto wrapper instead of an oil derrick. Texans considering any investment pitched through social media, billboards, or an unsolicited contact should check the Texas State Securities Board's own registration records before sending money, since a legitimate offering has no reason to avoid the disclosure requirements Texas has required by law for more than a hundred years.`,
    categorySlug: 'investment-fraud',
    sources: ['Texas State Historical Association', 'Texas State Securities Board'],
    sourceUrl: 'https://www.tshaonline.org/handbook/entries/blue-sky-law',
    country: 'US',
    state: 'TX',
    isHistorical: true,
    firstRecorded: '1923-05-15',
});

UsTZ.push({
    name: 'How the 1973 Deceptive Trade Practices Act Became Texas Consumers’ Strongest Legal Weapon',
    slug: 'texas-1973-deceptive-trade-practices-act-origin',
    description: `Before 1973, a defrauded Texas consumer had essentially one legal option: a common-law fraud claim, which required proving the seller knew a statement was false and intended to deceive — a high bar that left most people who were simply misled by exaggerated or deceptive marketing with no real recourse at all under the old rule of caveat emptor, "let the buyer beware." The nationwide consumer-rights movement of the late 1960s and early 1970s, and what the Texas Legislative Council would later describe as countless stories of Texans being taken advantage of by sellers, pushed the 63rd Texas Legislature to act: on May 21, 1973, Governor Dolph Briscoe signed House Bill 417, with companion Senate Bill 75, creating the Deceptive Trade Practices-Consumer Protection Act (DTPA) — legislation the Legislative Council itself called the most comprehensive consumer-protection statute of that session. Unlike a fraud claim, the DTPA let a consumer sue over a false, misleading, or deceptive act or practice in a consumer transaction without having to prove the seller's intent, and gave the law real teeth: a prevailing consumer is entitled to mandatory attorney's fees, and a business that acted "knowingly" faces treble damages, up to three times the consumer's actual loss.

More than fifty years later, the DTPA remains the exact statute Texas regulators and consumers reach for when a seller's marketing promises don't match what a buyer actually receives. That is precisely the law Texas Attorney General Ken Paxton's office cited when it opened a Civil Investigative Demand on July 29, 2026 into Caldwell-based Lone Star Pups, LLC, alleging the company misrepresented where its puppies actually came from and oversold the coverage of its marketed "10 Year Health Guarantee" — fine print that capped coverage for major hereditary conditions like cancer and seizures at just three years, not ten. Texas consumers don't have to wait for the Attorney General to act on their behalf: the DTPA's private right of action lets any misled buyer send the law's required pre-suit demand letter itemizing the deceptive claim and the resulting damages, a step that alone often prompts a settlement given a business's exposure to treble damages and mandatory attorney's fees if the case goes to court.`,
    categorySlug: 'pet-sales-scams',
    sources: ['Texas Legislative Council', 'US Law Explained'],
    sourceUrl: 'https://uslawexplained.com/texas_deceptive_trade_practices_act',
    country: 'US',
    state: 'TX',
    isHistorical: true,
    firstRecorded: '1973-05-21',
});
...
UsTZ.push({
    name: 'RentDue Capital Fraud-Recovery Scam Targeting Prior Victims',
    slug: 'utah-rentdue-capital-fraud-recovery-scam',
    description: `Weeks after Utah's Division of Securities publicized its case against Matthew Shane Perkins and RentDue Capital LLC — the fake day-trading fund that took roughly $89 million from more than 200 investors — the Division issued a follow-up investor alert on May 19, 2026 warning that a second wave of fraud had begun targeting the same victims. The Division said it had received reports of fictitious law firms reaching out to former RentDue Capital investors over social media and various messaging platforms, falsely claiming they had been retained or authorized to investigate the case and recover investors' lost funds. The pitch mirrors the classic recovery-scam pattern seen after other investment frauds: someone who already lost money is offered a second chance to get it back, provided they first hand over financial information, personal identification, or an upfront fee, none of which leads to any actual recovery. The Division urged former RentDue investors to "be skeptical of unsolicited messages, advertisements, or social media comments offering to recover funds lost to RentDue Capital," to "never share financial data, personal identification, or upfront fees with unknown individuals promising investment recovery," and to independently verify any purported legal representative by contacting the state bar association or the specific government agency the person claims to represent, rather than relying on contact information the caller or message provides. Anyone contacted this way is advised to file a report directly with the Utah Division of Securities, since a legitimate government investigation never requires the victims themselves to pay a fee to participate in it.`,
    categorySlug: 'investment-fraud',
    alertLevel: 'medium',
    sources: ['Utah Division of Securities', 'Utah Department of Commerce'],
    sourceUrl: 'https://commerce.utah.gov/2026/05/19/investor-alert-rentdue-capital/',
    country: 'US',
    state: 'UT',
    isHistorical: true,
...
UsTZ.push({
    ...
    categorySlug: 'public-benefits-fraud',
    alertLevel: 'medium',
    sources: ["U.S. Attorney's Office, Eastern District of Wisconsin", 'U.S. Department of Labor, Office of Inspector General'],
    sourceUrl: 'https://urbanmilwaukee.com/pressrelease/milwaukee-women-sentenced-to-prison-for-stealing-unemployment-benefits-during-covid-pandemic/',
    country: 'US',
    state: 'WI',
    isHistorical: true,
...
UsTZ.push({
    name: 'Chantilly Broker\'s Investor Fraud and Hidden-Crypto Bankruptcy Scheme (Jihoon Park)',
    slug: 'virginia-chantilly-jihoon-park-investor-bankruptcy-fraud',
    description: `Jihoon Park, 52, of Chantilly, Virginia, worked as a registered broker affiliated with MML Investors Services, LLC out of Fairfax after entering the securities industry in 2016. Prosecutors said Park used that affiliation and personal relationships with people in his community to solicit their life savings and retirement funds, promising "safe" investments with high-yield returns. Instead of investing the money as promised, Park transferred more than $2.5 million from multiple victims to himself, using it to buy cryptocurrency and to help fund a personal residence in Chantilly. When one victim sued him to try to recover the money, Park transferred assets into his wife's name and concealed millions of dollars in cryptocurrency he still held, then filed for Chapter 7 bankruptcy on January 14, 2025, falsely telling the bankruptcy court under oath that he had only $0.34 in financial assets and no cryptocurrency at all — an effort prosecutors say was designed to keep his victims from ever recovering a dollar of what he had stolen. A federal jury in the U.S. District Court for the Eastern District of Virginia in Alexandria convicted Park on September 8, 2026, of three counts of wire fraud and two counts of bankruptcy fraud; he faces up to 20 years in prison on each wire-fraud count and up to 5 years on each bankruptcy-fraud count at sentencing, scheduled for December 10, 2026. The case shows that a broker's professional affiliation and industry credentials are not proof that a specific investment opportunity is real — verify any individual investment or promissory note independently through FINRA's BrokerCheck and the SEC rather than relying on the broker's employer name alone, and be aware that even a court-supervised bankruptcy filing does not automatically protect a defrauded creditor if the debtor is concealing assets, which is itself a separate federal crime.`,
    categorySlug: 'investment-fraud',
    alertLevel: 'high',
    sources: ["U.S. Department of Justice", 'Hoodline'],
    sourceUrl: 'https://hoodline.com/2026/09/chantilly-broker-convicted-in-2-5-million-fraud-hid-crypto-from-bankruptcy-court/',
    country: 'US',
    state: 'VA',
    isHistorical: true,
