...
UsTZ.push({
    name: 'St. Croix Law Firm Office Manager Payroll Embezzlement (Nicole Morales)',
    slug: 'virgin-islands-morales-law-firm-payroll-embezzlement',
    description: `Nicole Morales, a St. Croix resident originally from California, worked as office manager for the law firm Nichols, Newman, Logan, Grey, and Lockwood, P.C., a position that put her in charge of processing the firm's payroll through Banco Popular using QuickBooks accounting software. Starting in December 2015, Morales began inflating her own payroll figures in QuickBooks before wiring the excess funds from the firm's Banco Popular account into three separate personal bank accounts she controlled, then editing the QuickBooks records back down to her correct pay before generating the reports her employer actually reviewed and approved — hiding the theft inside the same software the firm relied on to catch it. She kept the scheme running for more than three years, from December 2015 until January 2019, ultimately embezzling $372,496.34 from her employer. Morales pleaded guilty in November 2024 to three counts of wire fraud, and District Judge Wilma A. Lewis sentenced her in March 2025 to 16 months in federal prison, along with $372,496.34 in restitution and a $300 special assessment. The case is a reminder that a single trusted bookkeeper who both moves the money and produces the only records anyone else reviews can rewrite the evidence of their own theft after the fact — small offices in the territory can guard against this by having an owner or an outside accountant periodically reconcile bank statements directly against payroll and invoices, rather than relying solely on reports generated by the same employee who controls the underlying accounting software.`,
    categorySlug: 'identity-theft',
    alertLevel: 'low',
    sources: ["U.S. Attorney's Office, District of the Virgin Islands", 'St. Croix Source', 'St. Thomas Source'],
    sourceUrl: 'https://www.justice.gov/usao-vi/pr/st-croix-woman-sentenced-37200000-embezzlement-scheme',
    country: 'US',
    state: 'VI',
    isHistorical: true,
