...
UsAF.push({
    name: 'California PACE Loan Property-Lien Scheme (Ygrene Energy Fund)',
    slug: 'california-ygrene-pace-loan-property-lien-scheme',
    description: `Ygrene Energy Fund pitched California homeowners on Property Assessed Clean Energy (PACE) financing — a form of home-improvement loan for solar panels, roofing, or other energy-efficient upgrades that gets repaid not through an ordinary loan bill but through an increase tacked directly onto the homeowner's property tax bill, secured by a lien against the home itself. California Attorney General Rob Bonta and the Federal Trade Commission announced a settlement with Ygrene on October 28, 2022, alleging the company and its network of contractors used forgery and impersonation — filling out loan paperwork and even completing enrollment verification calls on a homeowner's behalf without their knowledge — to sign consumers up, deployed high-pressure sales tactics that rushed people through contract review, and misrepresented that a PACE lien would not complicate a future home sale or refinance, when in reality unpaid PACE assessments run with the property and can block a sale or refinancing until the balance is paid off. "Ygrene Energy Fund took advantage of hardworking California families, jeopardizing their most valuable asset in the process," Bonta said, while the FTC's Samuel Levine put it more bluntly: "Ygrene and its sales force deceived consumers about home improvement financing and stuck them with liens." The settlement did not erase liens already placed on borrowers' homes, and on July 8, 2025 the FTC disbursed $2.9 million in refunds to 960 affected consumers while cautioning that the underlying liens "remain outstanding until paid" for anyone who hasn't separately resolved them with the company. Homeowners approached about PACE or similar clean-energy financing should understand it is a loan repaid over 10 to 20 years through their property tax bill, not free government assistance, should never let a contractor or salesperson fill out financing paperwork or complete a verification call in their name, and should get independent financial advice and read every document themselves before agreeing to place a lien on their home.`,
    categorySlug: 'home-improvement-solar',
    alertLevel: 'medium',
    sources: ['California Department of Justice, Office of the Attorney General', 'Federal Trade Commission'],
    sourceUrl: 'https://oag.ca.gov/news/press-releases/attorney-general-bonta-and-ftc-announce-settlement-clean-energy-financing',
    country: 'US',
    state: 'CA',
});

UsAF.push({
    name: 'FTC v. JustAnswer Hidden-Subscription Lawsuit',
    slug: 'ftc-justanswer-hidden-subscription-lawsuit',
    description: `The Federal Trade Commission sued JustAnswer LLC — which operates JustAnswer.com and related "Ask a ___" sites including AskALawyerOnCall.com, AskAVeterinarianOnline.com, and AskWomensHealth.com — and its founder and CEO, Andrew Kurtzig, on January 13, 2026 in the U.S. District Court for the Northern District of California, alleging the company built its consumer funnel around hiding a recurring monthly charge behind what looked like a one-time payment. According to the complaint, JustAnswer advertised a nominal "join" fee of $1 to $5 to get an answer to a single question from an expert, but a consumer who paid that fee was immediately and automatically enrolled in an ongoing monthly subscription billed at $28 to $125 — without the clear, conspicuous disclosure or affirmative consent the Restore Online Shoppers' Confidence Act (ROSCA) requires before charging someone on a recurring basis. The FTC says some versions of the payment page included a consent checkbox, but it came pre-checked, so a consumer never had to click anything indicating agreement to a recurring charge, and the surrounding disclosure omitted the actual subscription price altogether. "JustAnswer's misleading pricing tactics obscured the true price of its services, preventing consumers from making an informed choice," said Christopher Mufarrige, Director of the FTC's Bureau of Consumer Protection, in announcing the case. The lawsuit is part of a broader wave of 2026 FTC subscription-cancellation enforcement that followed a federal appeals court striking down the agency's "click-to-cancel" rule in 2025 — rather than waiting on a new rule, the FTC has pursued individual companies directly under ROSCA, including a record $2.5 billion settlement with Amazon over Prime enrollment and cancellation practices and an active case against Uber over its Uber One subscription. The FTC is asking the court to bar JustAnswer from the practice going forward and to order consumer refunds and civil penalties against both the company and Kurtzig personally. Anyone paying a small "one-time" fee for an online service should look for the word "subscription" or "monthly" near the payment button before entering a card number, check whether any box agreeing to recurring billing is already pre-checked, and review bank and card statements for an unexpected recurring charge that traces back to what seemed like a single small payment.`,
    categorySlug: 'subscription-traps',
    alertLevel: 'medium',
    sources: ['Federal Trade Commission'],
...
UsAF.push({
    name: 'CMA Fest Ticket and Music-Industry Impersonation Scams ("Don\'t Fall for the Act")',
    slug: 'cma-fest-ticket-music-industry-impersonation-scam',
    description: `Ahead of the 2026 CMA Fest in downtown Nashville, the FBI's Nashville Field Office partnered with the Nashville Songwriters Association International on a public-awareness campaign called "Don't Fall for the Act," warning fans and music-industry professionals about a cluster of scams that spike around the festival: fake ticket and meet-and-greet sales, social-media impersonation of artists and industry figures, account takeovers, extortion attempts, and fraudulent business-opportunity pitches aimed at songwriters and performers. FBI Nashville Special Agent in Charge Terence Reilly said artificial intelligence is making the impersonation schemes harder to spot: "Artificial intelligence is getting only more sophisticated. We can see people representing themselves to be a country music artist and asking a fan for money." According to complaints filed with the FBI's Internet Crime Complaint Center, fans lost more than $325,000 between January 2024 and September 2025 to non-delivery scams involving concert tickets, festival passes, meet-and-greet packages, and merchandise that was paid for but never arrived — losses tracked specifically around ticketed live-music events like CMA Fest, where sellers flood Facebook groups and direct messages with deals that never materialize once payment is sent. The FBI advises buying tickets only through verified vendors, scrutinizing seller and website URLs closely before entering payment information, turning on multi-factor authentication for ticketing and social-media accounts, and treating any seller who pressures for immediate payment or offers an unrealistically good deal as a red flag. Fans and industry professionals who believe they've been targeted are urged to file a report with IC3 at ic3.gov within the first 24 hours, since authorities have a meaningfully better chance of recovering stolen funds before the money is moved overseas the longer a victim waits to report it.`,
    categorySlug: 'online-shopping-scams',
    alertLevel: 'medium',
    sources: ['FBI Nashville Field Office', 'Nashville Songwriters Association International', 'FBI Internet Crime Complaint Center (IC3)'],
    sourceUrl: 'https://www.fbi.gov/contact-us/field-offices/nashville/news/fbi-nashville-warns-tennesseans-about-criminal-and-cybercriminal-activity-targeting-the-music-industry',
    country: 'US',
    state: 'TN',
});
...
UsAF.push({
    name: 'Fake Hollywood Casting Director Union-Fee Impersonation Scam',
    slug: 'fake-hollywood-casting-director-union-fee-scam',
    description: `Scammers have spent 2025 and 2026 impersonating real, working Hollywood casting directors — including Linda Lowy ("Grey's Anatomy," "Friday Night Lights"), Carmen Cuba ("Stranger Things"), Margery Simkin ("Avatar"), J.J. Ogilvy ("Riverdale," "The Good Doctor"), Avy Kaufman, Rachel Tenner ("Fargo," "Severance"), and "Wicked" casting director Tiffany Little Canfield's peers — to target aspiring actors with fake job offers. Contact typically comes by email or social media, requesting headshots and self-tapes and dangling a supposed role on a real, high-profile production (HBO Max and Apple TV+ titles have both been named), before the "casting director" or a fake "SAG-AFTRA administrator" demands a union initiation fee, commonly around $3,000, paid by bank transfer, PayPal, or Cash App. One scheme used the email address "SAG-AFTRA@contractor.net" and directed payments to an account under the name "Adeleye Ayobami" in Kansas City. In a more sophisticated version, a scammer impersonating Margery Simkin sent targets an AI-generated voice memo saying, "I am sending this voice note to clear the air and let you know this is truly me," to overcome suspicion after victims grew wary of text-only contact. The Casting Society identified 13 fake Gmail addresses impersonating Kaufman alone and 8 impersonating Cuba, and Kaufman says she personally receives "at least a couple of emails about these schemes a day." A 24-year-old aspiring actress, Isabella Schaub, was targeted but caught the fraud before paying. SAG-AFTRA issued a formal member alert on January 12, 2026 confirming it never asks a third party to pay a joining fee on a performer's behalf and that legitimate union correspondence only ever comes from a sagaftra.org address. Demanding an upfront fee to "secure" a role or union membership also violates California's Krekorian Talent Scam Prevention Act. Anyone contacted about an unsolicited casting opportunity that requires payment of any kind before a real job exists should treat it as fraudulent, verify the supposed casting director independently through their own production company or agent, and report the contact to SAG-AFTRA at info@sagaftra.org.`,
    categorySlug: 'job-task-scams',
    alertLevel: 'high',
    sources: ['SAG-AFTRA', 'The Hollywood Reporter', 'Casting Society of America'],
    sourceUrl: 'https://www.sagaftra.org/reports-casting-scams-targeting-performers',
    country: 'US',
});
...
UsAF.push({
    name: 'Pasadena Staged Porsche Crash Insurance Fraud Ring',
    slug: 'california-pasadena-staged-porsche-crash-insurance-fraud',
    description: `The California Department of Insurance announced on February 27, 2026 that Sarkis Dishchyan, 47, Ani Suzie Labbad, 47, and Violett Lara Labbad, 44, all of Pasadena, had been arraigned on multiple felony counts of insurance fraud after investigators unwound a staged-crash scheme built around a rented car and a Porsche Cayenne. According to the department, the case began when a suspicious-claim referral led investigators to an out-of-state recruit who said Dishchyan had offered him $5,000, plus paid airfare and a hotel room, to fly from Illinois to California and rent a vehicle. Once he arrived, investigators say Dishchyan got behind the wheel of that rental and deliberately rear-ended a Porsche Cayenne hard enough to flip the rental onto its roof with the recruit still inside. The Porsche was actually being driven by Violett Labbad, who handed responding Pasadena police her sister-in-law Ani Labbad's driver's license and identified herself as Ani at the scene, while the real Ani Labbad stayed home and later filed the claim that paid out $38,932.21. Investigators said cell-site data placed both Dishchyan and Violett Labbad at the collision site at the time of the crash while Ani Labbad's phone showed her at her residence, and recovered text messages between Dishchyan and Violett — including one reading "on her way" — timestamped just minutes before impact. All three defendants pleaded not guilty at their February 20, 2026 arraignment, with the Los Angeles County District Attorney's Office prosecuting the case. The scheme is a reminder that an unsolicited offer of quick cash to "help out" with a car rental or a minor accident, often circulated through social media or word of mouth, can make the recruit a co-defendant rather than a bystander once investigators trace the phone records and payment trail — and that insurers and regulators increasingly reconstruct a crash's real timeline through cell-site location data and text messages, not just the story told at the scene.`,
    categorySlug: 'insurance-fraud',
    alertLevel: 'high',
    sources: ['California Department of Insurance', 'Insurance Journal'],
    sourceUrl: 'https://www.insurance.ca.gov/0400-news/0100-press-releases/2025/release010-2026.cfm',
    country: 'US',
    state: 'CA',
});
...
UsAF.push({
    name: 'Florida "Formula One" Baby Formula Theft and Resale Ring',
    slug: 'florida-lake-worth-baby-formula-theft-resale-ring',
    description: `Florida Attorney General James Uthmeier announced on September 10, 2026, the results of a 15-month investigation, code-named "Formula One," into an organized retail theft ring that stole and resold baby formula from major retailers across the state. Investigators say Mohammed Alsaidi, 59, and Zeina Abdul-Hassan Sou Zabib, 49, both of Lake Worth, ran a fencing operation out of their home and a warehouse in nearby Davie, paying a network of "boosters" — professional shoplifters — roughly $10 per stolen can, about one-fifth of retail price, before storing, repackaging, and reselling the formula for profit. The Florida Attorney General's Special Investigative Retail Theft Task Force, working with the Palm Beach County Sheriff's Office and partner agencies across six judicial circuits, tied the enterprise to more than 150 documented thefts from Publix, Target, Walmart, Walgreens, CVS, and Winn-Dixie stores dating back to 2024, generating an estimated $1.1 million in illicit revenue between November 2024 and June 2025 alone. When investigators executed search warrants on September 1, 2026, they recovered roughly 1,000 cans of formula, with a retail value of about $38,000, from the Davie warehouse. Alsaidi and Zabib each face a charge of conspiracy to commit racketeering and two counts of directing the dealing in stolen property, first-degree felonies carrying up to 90 years in prison combined, while nine accused boosters — including Kenneth Jones Jr., linked to more than 50 thefts totaling over $70,000 — face related theft and dealing-in-stolen-property charges. "Stealing baby formula away from parents who rely on it to feed their children is unconscionable," Uthmeier said in announcing the arrests, and Palm Beach County Sheriff Ric Bradshaw added, "We can't overlook the impact these crimes have on our community." Because stolen formula moves outside manufacturers' normal cold-chain and quality-control custody before resale, there is no way to verify it was stored, handled, or kept within its labeled shelf life — a real safety risk for infants who depend on it. Parents should buy formula only from established retailers or pharmacies, be wary of formula sold individually or in bulk lots at a steep discount through flea markets, unlicensed resellers, or unfamiliar online marketplace sellers, and check that safety seals are intact and lot numbers haven't been tampered with before ever giving it to a child.`,
    categorySlug: 'online-shopping-scams',
    alertLevel: 'high',
    sources: ["Florida Attorney General's Office", 'Palm Beach County Sheriff\'s Office', 'ClickOrlando/WKMG'],
    sourceUrl: 'https://www.clickorlando.com/news/local/2026/09/10/crime-ring-busted-over-florida-baby-formula-scheme-ag-announces/',
    country: 'US',
    state: 'FL',
});

UsAF.push({
    name: 'Adroit Health Group Deceptive Non-Insurance Health Plan Marketing Settlement',
    slug: 'adroit-health-group-massachusetts-deceptive-health-plans-settlement',
    description: `Massachusetts Attorney General Andrea Joy Campbell announced a $5 million settlement, entered in Suffolk Superior Court on April 29, 2026, resolving a lawsuit against Adroit Health Group LLC, The Adroit Group LLC, and A1 Health Group LLC — a Texas-based operation doing business under a rotating set of names including "Strata Health Group" — over how it marketed and sold health coverage to Massachusetts consumers from 2016 until around January 2022. The Attorney General's complaint alleged Adroit's telemarketers described what were actually discount health plans, limited-benefit policies, and health care sharing arrangements using insurance terminology like "PPO" and "coverage," and operated enrollment websites designed to resemble official or government-sponsored marketplaces, leading consumers to believe they were buying comprehensive coverage that satisfied the Affordable Care Act's and Massachusetts's own minimum creditable coverage requirements when it did not. Once enrolled, according to the complaint, consumers discovered gaps in coverage only when a real medical bill came due, and many who tried to cancel ran into unauthorized continued billing: cancellation requests submitted by email went unprocessed, callers seeking to cancel were routed back to the original sales agent who had signed them up, and refunds owed during the plans' own advertised "free-look" period were withheld while billing continued. Under the settlement, reached without an admission of liability, Adroit must pay $5 million in installments through 2028 — $2 million in initial restitution to affected consumers, followed by $1.5 million in March 2027 and a final $1.5 million in March 2028 covering additional restitution, civil penalties, and the state's investigation costs — and is permanently barred from marketing or selling any health insurance or non-insurance health program to Massachusetts residents. Anyone shopping for health coverage outside an official ACA marketplace or a known insurer should ask a salesperson to state in writing, before paying anything, whether the product is a regulated insurance policy or a non-insurance discount or sharing plan, verify a plan and its underwriter through the Massachusetts Division of Insurance or their own state's insurance regulator, and treat a website that looks like a government exchange but asks for payment before showing regulator or plan-name details as a red flag.`,
    categorySlug: 'medicare-health-plans',
    alertLevel: 'medium',
    sources: ["Massachusetts Attorney General's Office", 'Law360', 'Agency Checklists'],
    sourceUrl: 'https://www.mass.gov/news/ag-campbell-secures-5-million-settlement-with-adroit-for-unfair-and-deceptive-sales-and-administration-of-health-plans',
    country: 'US',
    state: 'MA',
});
...
UsAF.push({
    ...
    slug: 'california-neptune-society-sci-preneed-cremation-deceptive-marketing',
    description: `Neptune Society and Trident Society, the two brands Service Corporation International (SCI) — the country's largest funeral and cremation services corporation — uses to sell prepaid cremation plans in California, marketed a "Standard Plan" as a single, simply priced package covering both the cremation service and related merchandise like an urn. According to a lawsuit California Attorney General Rob Bonta's office filed and settled on May 1, 2024, that single-price pitch was misleading: SCI actually split each sale into two separate contracts behind the scenes, placed only the cremation-service portion of a customer's payment into the state-mandated trust account meant to protect prepaid funds, and kept the merchandise payment outside that protection entirely. The practical effect showed up when customers tried to cancel: SCI advertised a 30-day window to cancel for a full refund, but California law actually lets a prepaid-funeral customer cancel and get their money back at any time before the services are performed, and when customers did cancel, the company often refunded only the cremation-service portion while keeping what they had paid for merchandise. The settlement required SCI to pay $23 million in civil penalties and provide full restitution to affected customers who had cancelled but not received complete refunds, along with injunctive terms requiring clearer contract disclosures going forward. "California's robust consumer protection laws protect all Californians from unlawful, unfair, and fraudulent business and marketing practices," Attorney General Bonta said in announcing the resolution. Consumers considering a prepaid cremation or funeral plan should know they are never required to prepay at all, should ask specifically whether 100% of what they pay — including any merchandise — goes into a trust or insurance-funded account, should get the cancellation and refund terms in writing rather than relying on a salesperson's verbal description, and can check a preneed provider's licensing and complaint history through California's Cemetery and Funeral Bureau before signing anything.`,
    categorySlug: 'insurance-fraud',
    alertLevel: 'medium',
    sources: ["California Attorney General's Office", "California Cemetery and Funeral Bureau"],
    sourceUrl: 'https://oag.ca.gov/news/press-releases/attorney-general-bonta-announces-service-corporation-international-nation%E2%80%99s',
    country: 'US',
    state: 'CA',
    isHistorical: true,
...
UsAF.push({
    name: 'Alliance Moving and Storage Broker Hostage Scheme',
    slug: 'florida-alliance-moving-storage-falcone-hostage-scheme',
    description: `Richard Falcone ran a network of South Florida moving businesses — Alliance Moving and Storage in Boca Raton, American Wide Relocation and American Movers and Storage in Lake Park, and First Priority Van Lines in West Palm Beach — that marketed themselves as professional, full-service interstate movers but actually operated as unlicensed brokers, quietly reselling each customer's job to an outside carrier the customer never agreed to and often never learned about. According to a civil complaint the Florida Attorney General's Office filed in the Fifteenth Judicial Circuit in Palm Beach County on June 4, 2024, Falcone registered the companies under multiple fictitious names specifically to obscure that they were all the same operation, gave customers low initial estimates to book the job, then sharply raised the price once their belongings were already loaded onto the truck and effectively held the shipment for the higher amount — refusing refunds and giving false or evasive responses to the complaints that followed. The pattern is documented in complaints from at least 150 consumers who paid more than $1 million combined since 2018, and the U.S. Department of Transportation's Office of Inspector General assisted the state's Consumer Protection Division in the investigation. Before booking any interstate move, verify the company's USDOT number directly on the FMCSA's own database rather than trusting a number given by the salesperson, get the full binding estimate in writing, and treat a mover who won't clearly identify which company is actually going to be driving the truck as a sign your belongings could be held for a higher price on moving day.`,
    categorySlug: 'home-improvement-solar',
    alertLevel: 'high',
    sources: ["Florida Attorney General's Office (Ashley Moody)", 'U.S. DOT Office of Inspector General'],
    sourceUrl: 'https://www.oig.dot.gov/library-item/46492',
    country: 'US',
    state: 'FL',
    isHistorical: true,
...
UsAF.push({
    name: 'Vision Solar Deceptive Sales and Dividend Finance Loan Relief Settlement',
    slug: 'connecticut-vision-solar-dividend-finance-settlement',
    description: `Vision Solar, LLC pressured Connecticut homeowners into signing long-term loans for rooftop solar systems using high-pressure sales tactics and misrepresentations about savings, and in some cases the systems it installed were never activated or connected to the grid because Vision Solar never applied for or obtained the permits needed to interconnect them, leaving consumers stuck repaying loans for equipment that did not work as promised. Connecticut Attorney General William Tong sued the company, and a Hartford Superior Court judge entered a $5 million stipulated judgment against it in October 2024 — but Vision Solar had already filed for bankruptcy and lacked the assets to pay it, so Tong's office turned to the lenders that had financed the deals. In 2025 his office reached a settlement with Dividend Finance, the largest of Vision Solar's financing partners, requiring the lender to provide relief directly to Connecticut borrowers who took out Dividend-financed loans for defective or misrepresented Vision Solar installations. Tong's office has continued pursuing other companies and salespeople in the same rooftop-solar sales pipeline. Homeowners approached about "free" or heavily discounted solar power should get the full financing terms and projected savings in writing, confirm directly with their town's building department whether the required electrical and interconnection permits were actually pulled before signing off on a completed job, and should contact the loan company as well as the installer if a system is never activated, since a settlement with the lender — not just the contractor — is often what actually delivers a refund once a solar company has gone out of business.`,
    categorySlug: 'home-improvement-solar',
    alertLevel: 'medium',
...
UsAF.push({
    name: '"Personal Tradelines" Credit-Repair Piggybacking Settlement',
    slug: 'colorado-personal-tradelines-credit-repair-piggybacking-settlement',
    description: `PersonalTConsulting LLP, doing business as Personal Tradelines, marketed a credit-repair service to Colorado consumers built around "piggybacking" — adding a customer as an authorized user on a stranger's older, well-managed credit card account, in exchange for a fee, on the theory that the account's age and payment history would boost the customer's own credit score. The Colorado Attorney General's Office found the company charged consumers in advance of performing any service, made unsubstantiated and misleading claims about how much a tradeline would actually raise a score, and skipped the disclosures Colorado's Credit Services Organization Act requires credit-repair companies to give consumers before they pay — while the customer was never allowed to actually use the account being "rented" to them, since the arrangement existed solely on paper for scoring purposes. Attorney General Phil Weiser's office announced a settlement on December 4, 2025 requiring the company to stop offering credit-repair services to Colorado consumers entirely, to comply with the Credit Services Organization Act going forward, and to pay $20,000 in administrative penalties to the state. Piggybacking is not illegal on its own, but a company that wants payment up front before improving a score, cannot explain in specific terms how much a given tradeline will help, or won't put the required credit-services disclosures in writing is showing the same warning signs regulators found here; Coloradans who believe they were harmed by this or a similar credit-repair offer can file a complaint at stopfraudcolorado.gov.`,
    categorySlug: 'debt-relief-scams',
    alertLevel: 'medium',
    sources: ["Colorado Attorney General's Office (Phil Weiser)"],
    sourceUrl: 'https://coag.gov/press-releases/weiser-settlement-denver-credit-repair-company/',
    country: 'US',
    state: 'CO',
});
...
UsAF.push({
    name: 'Gazelle Investors Foreclosure Equity-Stripping Scheme',
    slug: 'arizona-gazelle-investors-foreclosure-equity-stripping-scheme',
    description: `Cameron Jones, operating as Gazelle Investors, and Samuel Sutton, operating as Magnum Financial, tracked county recorder websites for newly filed foreclosure notices and then sent "door knockers" to approach the homeowners named in them, according to a lawsuit Arizona Attorney General Kris Mayes filed in Maricopa County Superior Court on March 12, 2025. Some of those door knockers posed as representatives of a fabricated charity called "Arizona's Helping Hands" rather than disclosing they worked for a real-estate investment operation, and the complaint alleges the network used high-pressure tactics and invalid contracts to acquire distressed homes for far below market value while keeping cancellation rights for themselves — then filed fraudulent bankruptcy and probate paperwork under the homeowners' names to delay scheduled foreclosure auctions long enough to flip the properties through a web of shell companies, with title companies and law firms accused of notarizing the deeds despite obvious red flags. The Attorney General is seeking civil penalties of $10,000 per violation, dissolution of the companies involved, and a permanent ban on the defendants from any Arizona real estate transactions. A homeowner who receives an unsolicited visit or call shortly after a public foreclosure filing should be immediately suspicious of anyone offering to "help," and should never sign a deed transfer — even one described as temporary or as part of a trust — without review by an attorney of their own choosing, since Arizona law already entitles a homeowner in default to free HUD-approved foreclosure counseling.`,
    categorySlug: 'mortgage-foreclosure-scams',
    alertLevel: 'high',
    sources: ["Arizona Attorney General's Office (Kris Mayes)"],
    sourceUrl: 'https://www.azag.gov/press-release/attorney-general-mayes-sues-real-estate-operators-and-title-companies-defrauding',
    country: 'US',
    state: 'AZ',
    isHistorical: true,
